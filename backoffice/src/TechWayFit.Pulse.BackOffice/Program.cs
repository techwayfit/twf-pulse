...
// ── Database initialization (MariaDB - manual scripts required) ─────────────
// Note: BackOffice tables must be created via SQL scripts.
// See: backoffice/src/TechWayFit.Pulse.BackOffice.Core/Scripts/v1.0/MariaDB/
